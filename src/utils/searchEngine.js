...
export const SYNONYMS = {
  // ===== LOCATIONS =====
  bangalore: ["bengaluru", "blr", "bangaluru", "banglore", "bengalore"],
  bengaluru: ["bangalore", "blr"],
  delhi: ["new delhi", "ncr", "dilli"],
  mumbai: ["bombay", "mumbai city", "bombai", "mumabi"],
  chennai: ["madras", "chenai", "channai"],
  kolkata: ["calcutta", "kolkatta"],
  hyderabad: ["hyd", "secunderabad", "hydrabad", "hyderbad"],
  pune: ["poona"],
  ahmedabad: ["amdavad"],
  kochi: ["cochin"],
  trivandrum: ["thiruvananthapuram", "trivandram"],
  gurgaon: ["gurugram", "gurgon"],
  noida: ["greater noida"],
  vizag: ["visakhapatnam", "vishakapatnam"],
  tirupati: ["tirupathi"],
  mangalore: ["mangaluru", "manglore"],
  belagavi: ["belgaum"],
  ...
  // ===== JOBS / WORK =====
  job: ["jobs", "work", "career", "employment", "role", "vacancy", "opening"],
  hiring: ["recruitment", "vacancy", "opening"],
  fresher: ["freshers", "entry level", "junior"],
  experienced: ["expert", "professional", "skilled", "senior"],
  intern: ["internship", "trainee"],
  trainee: ["intern"],

  // ===== JOB TYPES (INDIAN STYLE) =====
  bpo: ["call center", "customer support"],
  it: ["software", "tech"],
  hr: ["human resources"],
  accounts: ["accounting", "accountant"],
  backoffice: ["backend office", "non voice"],
  nonvoice: ["non voice process"],
  voice: ["voice process"],
  nightshift: ["night shift","night"],
  dayshift: ["day shift","morning"],

  // ===== SKILLED & HOME SERVICES =====
  plumber: ["plumbing", "pipe fitter", "water work"],
  electrician: ["electrical", "wiring", "current work"],
  carpenter: ["woodwork", "furniture maker", "woodworker"],
  painter: ["painting", "decorator", "wall painting"],
  cleaner: ["cleaning", "housekeeping", "maid", "domestic helper"],
  mechanic: ["mechanical", "technician", "repairman"],
  cook: ["chef", "home cook", "cook aunty"],
  driver: ["chauffeur", "cab driver", "taxi driver", "personal driver"],
  delivery: ["delivery boy", "delivery executive", "courier", "logistics", "delhivery"],
  security: ["guard", "watchman", "security guard"],
  babysitter: ["nanny", "child care", "caretaker"],
  tutor: ["teacher", "home tutor", "trainer"],
  gardener: ["gardening", "landscaping", "garden worker", "maligai worker"],
  helper: ["helper boy", "assistant"],
  labour: ["labor", "worker", "daily wage"],
  sweeper: ["cleaner"],

  // ===== PETS / ANIMALS =====
  dog: ["dogs", "puppy", "canine", "doggo", "street dog", "indie dog"],
  cat: ["cats", "kitten", "feline", "kitty", "desi cat"],
  pet: ["pets", "animal", "domestic animal", "companion"],
  adopt: ["adoption", "rescue"],
  vet: ["veterinary", "animal doctor", "pet doctor"],
  cow: ["gaay"],
  goat: ["bakra"],
  hen: ["chicken"],
  ...
  apartment: ["flat", "condo", "penthouse"],
  house: ["villa", "townhouse"],
  rent: ["rental", "lease", "for rent"],
  buy: ["purchase", "sale"],
  sale: ["selling", "resale"],
  pg: ["paying guest", "hostel", "pg accommodation"],
  room: ["rooms", "bedroom"],
  flatmate: ["roommate", "sharing"],
  owner: ["house owner", "landlord"],
  broker: ["agent", "property dealer"],
  deposit: ["advance"],
  ...
  // ===== BUY / SELL =====
  secondhand: ["second hand", "used", "pre owned"],
  resale: ["used", "second hand"],
  price: ["rate", "cost", "amount"],
  discount: ["offer", "deal"],
  free: ["no cost", "without charge"],
  negotiable: ["nego", "discussion possible"],

  // ===== FOOD / DAILY LIFE =====
  tiffin: ["mess", "home food"],
  tea: ["chai"],
  ...
  // ===== TRANSPORT =====
  auto: ["auto rickshaw", "auto wala", "uber", "ola"],
  cab: ["taxi"],
  bike: ["two wheeler", "motorcycle", "scooter"],
  scooty: ["scooter", "two wheeler"],
  car: ["four wheeler"],
  bus: ["government bus", "private bus"],

  // ===== DOCUMENTS =====
  aadhaar: ["aadhar", "uid"],
  pan: ["pan card"],
  license: ["dl", "driving license"],
  rc: ["vehicle rc"],
  passport: ["pp"],

  // ===== COMMON INTENTS =====
  nearby: ["near by", "around me", "close by"],
  urgent: ["immediate", "emergency", "asap"],
  available: ["available now", "ready", "open"],
  required: ["needed", "wanted"],
  contact: ["phone number", "call"],
  enquiry: ["inquiry", "query"],
  warranty: ["warrenty", "guarantee"],

  // ===== SEARCH BEHAVIOR =====
  repair: ["fix", "mend", "service", "maintenance"],
  cheap: ["affordable", "budget", "low cost", "inexpensive"],
  expensive: ["costly", "premium", "high end"],
  fast: ["quick", "speedy", "rapid"],
  good: ["great", "excellent", "quality", "best"],
  bad: ["poor", "worst", "low quality"],
  new: ["latest", "recent", "fresh"],
  old: ["used", "second hand", "vintage"],

  // ===== AVAILABILITY =====
  fulltime: ["full time", "permanent"],
  parttime: ["part time", "temporary", "partime"],
  freelance: ["remote", "work from home"],
  onsite: ["on site"],
  inoffice: ["in office"],
  hybrid: ["flexi", "flexible"]
};
